...
\textcolor{red}{(add some half-edges)}


\begin{problem}
   We open up the tubes at $x$ and $y$, and add small wooden sheets to keep in the water. Make arguments for the following axioms:
   \begin{axiom}
    We have a graph $G$ with edges labelled by positive real numbers $R_e$. 
...
\textcolor{red}{(add a list of axioms - also need to give an exercise showing linearity of addition wrt $I$)}
...
\begin{problem}
Make a table computing $P(x,y)$ and $R(x,y)$ for a few of your favourite graphs (don't forget to include simple ones!). Conjecture a relationship between $P(x,y)$ and $R(x,y)$, and prove it.
\end{problem}
