...
\end{problem}
   ...
   \begin{problem}
    The \textit{(effective) resistance} between two points is
      $$R(x,y) \ = \ $$
...
\node[above] at (v15) {$z$};
 ...
 gives $R_{G_1\cdot G_2}(x,z)= R_{G_1}(x,y)+R_{G_2}(y,z)$.
   \item What about if two graphs $G_1$ and $G_2$ are joined together along multiple vertices $y_1, \ldots, y_k$? 
